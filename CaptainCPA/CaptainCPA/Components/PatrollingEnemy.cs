...
namespace CaptainCPA.Components
{
	...
	{
		protected PatrollingEnemy(Game game, SpriteBatch spriteBatch, Texture2D texture, Color color, Vector2 position, float rotation, float scale, float layerDepth,
